...
export default {
    ...
    h: {
        ...
        tips: {
            ...
            accountAlreadyStopusing: '该账号已经被停止使用',
            customersDelete: '所属客户被删除',
            ...
            bindSuccess: '绑定成功',
            workDataExport: '工单数据导出',
            noFilterIsExportAllData: '当前未选择筛选条件，是否选择导出所有工单数据',
            againLogin: '修改成功，三秒后将退出登录，请重新登录......',
            getCode: '获取图形验证码',
            getSmsCode: '获取短信验证码与填写',
            confirmAgreement: '请确保两次密码输入一致',
        },
        header: {
            returnHome: '返回首页',
            returnParent: '返回上级',
        ...
        formLabel: {
            ...
            work: {
                ...
                sendPeople: '派单人',
                repairUser: '维修人员',
                repairUserPhone: '维修人员电话',
                signLng: '打卡经度',
                signLat: '打卡纬度',
                signDistance: '打卡地与客户所在地的距离',
                receiptPeople: '回单人',
                receiptContent: '回单内容',
                evaluate: '评价',
                cancelPeople: '取消人',
