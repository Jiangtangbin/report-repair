...
const languageMap: Record<Language, () => Promise<EsModuleComponent>> = {
    'zh-CN': () => import(/* webpackChunkName: "lang-zh-CN" */ '@/locale/lang/zh-CN'),
    'en-US': () => import(/* webpackChunkName: "lang-en-US" */ '@/locale/lang/en-US'),
};
...
export function loadLanguageAsync(lang: Language): Promise<Language> {
    if (i18n.locale !== lang) {
